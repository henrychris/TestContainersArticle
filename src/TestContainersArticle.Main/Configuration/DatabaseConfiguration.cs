...
using TestContainersArticle.Main.Configuration.Settings;

namespace TestContainersArticle.Main.Configuration
{
            ...
            services.AddDbContext<T>(options =>
            {
                options.UseNpgsql(
                    ...
                    o =>
                    {
                        ...
                        o.MigrationsAssembly("TestContainersArticle.Main");
